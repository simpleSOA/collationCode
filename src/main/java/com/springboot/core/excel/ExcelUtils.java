...
public class ExcelUtils {
    ...
    public static void exportExcel(List<?> list, String sheetName, Class<?> pojoClass, String fileName, HttpServletResponse response) throws IOException {
        ...
        exportParams.setStyle(ExcelExportStylerHeaderBoldImpl.class);
    ...
    public static void exportExcel(String sheetName, List<ExcelExportEntity> entityList,
                                   Collection<?> dataSet, String fileName, HttpServletResponse response) throws IOException {
        ExportParams exportParams = new ExportParams(null, sheetName, ExcelType.XSSF);
        exportParams.setStyle(ExcelExportStylerHeaderBoldImpl.class);
        Workbook excel = ExcelExportUtil.exportExcel(exportParams, entityList, dataSet);
        downLoadExcel(fileName, response, excel);
    }
    ...
    public static <T> List<T> importExcel(MultipartFile file, ImportParams params, Class<?> clazz) throws Exception {
