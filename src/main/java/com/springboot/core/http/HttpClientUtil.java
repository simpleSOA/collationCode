package com.springboot.core.http;
...
public class HttpClientUtil {
  ...
  //response解析器 BasicResponseHandler
  ...
  static {
    ...
    httpClient = HttpClients.custom().setKeepAliveStrategy((response, context) -> -1)
        .setDefaultRequestConfig(requestConfig).disableAutomaticRetries()
   ...
   */
  public static String sendHttpPost(String httpUrl, Map<String, String> maps, Charset charset,
      Map<String, String> headers) throws IOException {
  ...
  public static String sendHttpPostJson(String httpUrl, Map<String, String> headers, String json)
      throws IOException {
    ...
    httpPost.setEntity(requestEntity);
      return getHttpPostResponse(httpPost);
  }
  ...
  public static String sendHttpGet(String url, Map<String, String> maps,
      Map<String, String> headers) throws Exception {
    return sendHttpGet(url, maps, StandardCharsets.UTF_8, headers);
  }

  public static String sendHttpGet(String url, Map<String, String> maps, Charset charset,
      Map<String, String> headers) throws Exception {
    ...
    return getHttpClient().execute(httpGet, RESPONSE_HANDLER);
  }
   ...
   * 发送Post请求
   */
  private static String getHttpPostResponse(HttpPost httpPost) throws IOException {
