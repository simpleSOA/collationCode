...
public class HttpClientUtil {
    ...
    public static String sendHttpPostJson(String httpUrl, Map<String, String> headers, String json) throws IOException {
        ...
        String data = sendHttpPost(httpPost, StandardCharsets.UTF_8);
        return data;
    }
